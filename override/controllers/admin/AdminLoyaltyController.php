...
class AdminLoyaltyControllerCore extends AdminController
{
	protected $delete_mode;

	protected $_defaultOrderBy = 'date_add';
	protected $_defaultOrderWay = 'DESC';
	protected $can_add_customer = false;

	public function __construct()
	{
		$this->required_database = true;
		$this->table = 'customer';
		$this->className = 'Loyalty';
		$this->lang = false;
		...
		$this->fields_list = array(
			...
			'first_order' => array(
				'title' => $this->l('1 ère commande / 15 jours'),
				'width' => 'auto'
			),
			'order_modulo' => array(
				'title' => $this->l('Commande %5'),
				'width' => 'auto'
			)
