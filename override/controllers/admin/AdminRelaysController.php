		...
		$this->fields_form = array(
			...
			'input' => array(
				...
				array(
					...
					'desc' => $this->l('Include the shipping & handling costs in relay price')
				),
				array(
					'type' => 'radio',
					...
					'values' => array(
						array(
							'id' => 'billing_default',
							'value' => Relay::SHIPPING_METHOD_DEFAULT,
							'label' => $this->l('Default behavior')
						),
						array(
							'id' => 'billing_price',
							'value' => Relay::SHIPPING_METHOD_PRICE,
							'label' => $this->l('According to total price')
						),
						array(
							'id' => 'billing_weight',
							'value' => Relay::SHIPPING_METHOD_WEIGHT,
				...
				array(
					...
					'required' => false,
					'size' => 10,
					'desc' => $this->l('Maximum height managed by this relay. Set "0" or leave this field blank to ignore this.')
				),
				array(
					'type' => 'text',
					...
					'required' => false,
					'size' => 10,
					'desc' => $this->l('Maximum width managed by this relay. Set "0" or leave this field blank to ignore this.')
				),
				array(
					'type' => 'text',
					...
					'required' => false,
					'size' => 10,
					'desc' => $this->l('Maximum depth managed by this relay. Set "0" or leave this field blank to ignore this.')
				),
				array(
					'type' => 'text',
					...
					'required' => false,
					'size' => 10,
					'desc' => $this->l('Maximum weight managed by this relay. Set "0" or leave this field blank to ignore this.')
				),
				array(
					'type' => 'hidden',
					'name' => 'is_module'
