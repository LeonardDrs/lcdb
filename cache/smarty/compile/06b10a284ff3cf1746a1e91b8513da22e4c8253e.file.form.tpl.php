<?php /* Smarty version Smarty-3.1.8, created on 2013-03-20 00:06:10
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/project/lcdb/administration/themes/default/template/controllers/import/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4651238045148ef62f3c302-45385549%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '06b10a284ff3cf1746a1e91b8513da22e4c8253e' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/project/lcdb/administration/themes/default/template/controllers/import/helpers/form/form.tpl',
      1 => 1361836056,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4651238045148ef62f3c302-45385549',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5148ef6329ea98_85781282',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5148ef6329ea98_85781282')) {function content_5148ef6329ea98_85781282($_smarty_tpl) {?>
	...
	$(document).ready(function(){
		...
		$('#preview_import').submit(function(e) {
			if ($('#truncate').get(0).checked)
			{
				...
				{
					if (!confirm('<?php echo smartyTranslate(array('s'=>'Are you sure you want to delete','js'=>1),$_smarty_tpl);?>
...
'))
				...
				{
					jAlert('<?php echo smartyTranslate(array('s'=>'You do not have permission to delete here. When the multi-store is enable, only a SuperAdmin can delete all items before import.'),$_smarty_tpl);?>
');
					return false;
				}
			}
...
"><?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
			...
			<div style="width:50%; margin: 0 auto;">
				<a href="#" onclick="$('#sample_files_import').slideToggle(); return false;"><?php echo smartyTranslate(array('s'=>'Click to see our samples import csv files.'),$_smarty_tpl);?>
</a>
...
"Ipod;red.jpg<span class="bold" style="color: red">,</span>blue.jpg<span class="bold" style="color: red">,</span>green.jpg;129.90"
 ...
 <span id="entitie"><?php echo smartyTranslate(array('s'=>'categories'),$_smarty_tpl);?>
			...
			<label for="forceIDs" class="clear"><?php echo smartyTranslate(array('s'=>'Force all ids during import?'),$_smarty_tpl);?>
 </label>
			<div class="margin-form">
				<input name="forceIDs" id="forceIDs" type="checkbox"/> <?php echo smartyTranslate(array('s'=>'If you don\'t use this option, all IDs will be auto-incremented.'),$_smarty_tpl);?>
...
" class="button" <?php if (empty($_smarty_tpl->tpl_vars['files_to_import']->value)){?>disabled<?php }?>/>
				<?php if (empty($_smarty_tpl->tpl_vars['files_to_import']->value)){?><span style="color:red;"><?php echo smartyTranslate(array('s'=>'You must upload a file for go to the next step.'),$_smarty_tpl);?>
</span><?php }?>
			</div>
			...
			<div class="warn import_supply_orders_details" style="margin-top: 20px; display:none">
				<p><?php echo smartyTranslate(array('s'=>'Importing Supply Order Details will first reset the products ordered, if any.'),$_smarty_tpl);?>
</p>
			</div>
		<?php if (!count($_smarty_tpl->tpl_vars['files_to_import']->value)){?>
			<div class="warn" style="margin-top: 20px;">
				...
				<ul>
					<li><?php echo smartyTranslate(array('s'=>'You can read informations on CSV import at:'),$_smarty_tpl);?>
