<?php /* Smarty version Smarty-3.1.8, created on 2013-04-15 19:46:54
...
<?php /*%%SmartyHeaderCode:1175315547516c3d0e2f8052-00025413%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1175315547516c3d0e2f8052-00025413',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_516c3d0eb899d6_22369733',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_516c3d0eb899d6_22369733')) {function content_516c3d0eb899d6_22369733($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/XAMPP/xamppfiles/htdocs/project/lcdb/tools/smarty/plugins/modifier.escape.php';
?>
	...
	<tr id="product_options" <?php if (!$_smarty_tpl->tpl_vars['product']->value->active){?>style="display:none"<?php }?> >
		...
		<td style="padding-bottom:5px;">
			<ul class="listForm">
				...
				<li>
					<input type="checkbox" name="is_subscription" id="is_subscription" value="1" <?php if ($_smarty_tpl->tpl_vars['product']->value->is_subscription){?>checked="checked"<?php }?>/>
					<label for="is_subscription" class="t"><?php echo smartyTranslate(array('s'=>'Subscription'),$_smarty_tpl);?>
</label>
				</li>
			<li>
...
<br /></label>
			...
			<tr>
				<td class="col-left">
					<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('field'=>"tricks",'type'=>"tinymce",'multilang'=>"true"), 0);?>

					<label><?php echo smartyTranslate(array('s'=>'tips and Tricks:'),$_smarty_tpl);?>
<br /></label>
				</td>
				<td style="padding-bottom:5px;">
						<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/textarea_lang.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('languages'=>$_smarty_tpl->tpl_vars['languages']->value,'input_name'=>'tricks','input_value'=>$_smarty_tpl->tpl_vars['product']->value->tricks), 0);?>
			...
			<tr>
				<td class="col-left">
					<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('field'=>"breeder",'type'=>"tinymce",'multilang'=>"true"), 0);?>

					<label><?php echo smartyTranslate(array('s'=>'World of breeder:'),$_smarty_tpl);?>
<br /></label>
				</td>
				<td style="padding-bottom:5px;">
						<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/textarea_lang.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('languages'=>$_smarty_tpl->tpl_vars['languages']->value,'input_name'=>'breeder','input_value'=>$_smarty_tpl->tpl_vars['product']->value->breeder), 0);?>
