<?php /* Smarty version Smarty-3.1.8, created on 2013-05-15 22:54:17
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/project/lcdb/administration/themes/default/template/controllers/products/associations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20641942805193f5f922b003-70523122%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '63aa87b2c66ab2a4f31b028999bd8eb1c2484267' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/project/lcdb/administration/themes/default/template/controllers/products/associations.tpl',
      1 => 1368184776,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20641942805193f5f922b003-70523122',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5193f5f945a648_60590330',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5193f5f945a648_60590330')) {function content_5193f5f945a648_60590330($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/XAMPP/xamppfiles/htdocs/project/lcdb/tools/smarty/plugins/modifier.escape.php';
?>
...
" style="cursor: pointer;">
		...
		<tr>
			<td class="col-left"><label><?php echo smartyTranslate(array('s'=>'Recipes:'),$_smarty_tpl);?>
</label></td>
			<td style="padding-bottom:5px;">
				<input type="hidden" name="inputRecipes" id="inputRecipes" value="<?php  $_smarty_tpl->tpl_vars['recipe'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['recipe']->_loop = false;
...
?><?php echo $_smarty_tpl->tpl_vars['recipe']->value['id_product'];?>
-<?php } ?>" />
				<input type="hidden" name="nameRecipes" id="nameRecipes" value="<?php  $_smarty_tpl->tpl_vars['recipe'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['recipe']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['recipes']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['recipe']->key => $_smarty_tpl->tpl_vars['recipe']->value){
$_smarty_tpl->tpl_vars['recipe']->_loop = true;
?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['recipe']->value['name'], 'htmlall', 'UTF-8');?>
¤<?php } ?>" />

				<div id="ajax_choose_recipe">
					<p style="clear:both;margin-top:0;">
						<input type="text" value="" id="recipe_autocomplete_input" />
						<?php echo smartyTranslate(array('s'=>'Begin typing the first letters of the recipe name, then select the recipe from the drop-down list'),$_smarty_tpl);?>
...
?>
						<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['recipe']->value['name'], 'htmlall', 'UTF-8');?>
<?php if (!empty($_smarty_tpl->tpl_vars['recipe']->value['reference'])){?><?php echo $_smarty_tpl->tpl_vars['recipe']->value['reference'];?>
<?php }?>
						<span class="delRecipe" name="<?php echo $_smarty_tpl->tpl_vars['recipe']->value['id_product'];?>
" style="cursor: pointer;">
							<img src="../img/admin/delete.gif" class="middle" alt="" />
						</span><br />
					<?php } ?>
