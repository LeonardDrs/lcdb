<?php /* Smarty version Smarty-3.1.8, created on 2013-03-13 00:23:01
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/project/lcdb/modules/referralprogram/views/templates/front/program.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1262583474513fb8d53c6a00-40553902%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '047fdfddc14802ecf43b347f5d24a2846f3859b9' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/project/lcdb/modules/referralprogram/views/templates/front/program.tpl',
      1 => 1362580530,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1262583474513fb8d53c6a00-40553902',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_513fb8d5a012c9_74503204',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_513fb8d5a012c9_74503204')) {function content_513fb8d5a012c9_74503204($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/XAMPP/xamppfiles/htdocs/project/lcdb/tools/smarty/plugins/modifier.escape.php';
?>
...
"><?php echo smartyTranslate(array('s'=>'My account','mod'=>'referralprogram'),$_smarty_tpl);?>
</a><span class="navigation-pipe"><?php echo $_smarty_tpl->tpl_vars['navigationPipe']->value;?>
</span><?php echo smartyTranslate(array('s'=>'Referral Program','mod'=>'referralprogram'),$_smarty_tpl);?>
...
<h2><?php echo smartyTranslate(array('s'=>'Referral program','mod'=>'referralprogram'),$_smarty_tpl);?>
</h2>
...
<ul class="idTabs clearfix">
	<li><a href="#idTab1" <?php if ($_smarty_tpl->tpl_vars['activeTab']->value=='sponsor'){?>class="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Sponsor my friends','mod'=>'referralprogram'),$_smarty_tpl);?>
</a></li>
	<li><a href="#idTab2" <?php if ($_smarty_tpl->tpl_vars['activeTab']->value=='pending'){?>class="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Pending friends','mod'=>'referralprogram'),$_smarty_tpl);?>
</a></li>
	<li><a href="#idTab3" <?php if ($_smarty_tpl->tpl_vars['activeTab']->value=='subscribed'){?>class="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Friends I sponsored','mod'=>'referralprogram'),$_smarty_tpl);?>
</a></li>
</ul>
<div class="sheets">
	...
	<div id="idTab1">
		<p class="bold">
			<strong><?php echo smartyTranslate(array('s'=>'Get a discount of %d for you and your friends by recommending this Website.','sprintf'=>$_smarty_tpl->tpl_vars['discount']->value,'mod'=>'referralprogram'),$_smarty_tpl);?>
</strong>
		</p>
		<?php if ($_smarty_tpl->tpl_vars['canSendInvitations']->value){?>
			<p>
				...
				<?php }?>,
				<?php echo smartyTranslate(array('s'=>'he or she will receive a %1$d voucher and you will receive your own voucher worth %2$d.','sprintf'=>array($_smarty_tpl->tpl_vars['discount']->value,$_smarty_tpl->tpl_vars['discount']->value),'mod'=>'referralprogram'),$_smarty_tpl);?>

			</p>
			<form method="post" action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getModuleLink('referralprogram','program',array(),true);?>
" class="std">
				<table class="std">
				<thead>
					<tr>
...
]" size="14" value="<?php if (isset($_POST['friendsLastName'][$_smarty_tpl->getVariable('smarty',null,true,false)->value['section']['friends']['index']])){?><?php echo smarty_modifier_escape($_POST['friendsLastName'][$_smarty_tpl->getVariable('smarty')->value['section']['friends']['index']], 'htmlall', 'UTF-8');?>
<?php }?>" /></td>
						<td><input type="text" class="text" name="friendsFirstName[<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['friends']['index'];?>
]" size="14" value="<?php if (isset($_POST['friendsFirstName'][$_smarty_tpl->getVariable('smarty',null,true,false)->value['section']['friends']['index']])){?><?php echo smarty_modifier_escape($_POST['friendsFirstName'][$_smarty_tpl->getVariable('smarty')->value['section']['friends']['index']], 'htmlall', 'UTF-8');?>
<?php }?>" /></td>
						<td><input type="text" class="text" name="friendsEmail[<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['friends']['index'];?>
]" size="20" value="<?php if (isset($_POST['friendsEmail'][$_smarty_tpl->getVariable('smarty',null,true,false)->value['section']['friends']['index']])){?><?php echo smarty_modifier_escape($_POST['friendsEmail'][$_smarty_tpl->getVariable('smarty')->value['section']['friends']['index']], 'htmlall', 'UTF-8');?>
<?php }?>" /></td>
					</tr>
					<?php endfor; endif; ?>
				</tbody>
				...
				<p class="checkbox">
					...
					<a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getModuleLink('referralprogram','rules',array('height'=>'500','width'=>'400'),true);?>
" class="thickbox" title="<?php echo smartyTranslate(array('s'=>'Conditions of the referral program','mod'=>'referralprogram'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Read conditions.','mod'=>'referralprogram'),$_smarty_tpl);?>
</a>
				</p>
				<p class="see_email">
					<?php echo smartyTranslate(array('s'=>'Preview','mod'=>'referralprogram'),$_smarty_tpl);?>
 
					<?php $_smarty_tpl->tpl_vars["file"] = new Smarty_variable(($_smarty_tpl->tpl_vars['lang_iso']->value)."/referralprogram-invitation.html", null, 0);?>
					<a href="<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['file']->value;?>
<?php $_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getModuleLink('referralprogram','email',array('height'=>'500','width'=>'600','mail'=>$_tmp1),true);?>
" class="thickbox" title="<?php echo smartyTranslate(array('s'=>'Invitation e-mail','mod'=>'referralprogram'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'the default e-mail','mod'=>'referralprogram'),$_smarty_tpl);?>
</a> <?php echo smartyTranslate(array('s'=>'that will be sent to your friend(s).','mod'=>'referralprogram'),$_smarty_tpl);?>

				</p>
				<p class="submit">
					<input type="submit" id="submitSponsorFriends" name="submitSponsorFriends" class="button_large" value="<?php echo smartyTranslate(array('s'=>'Validate','mod'=>'referralprogram'),$_smarty_tpl);?>
" />
				</p>
			</form>
		<?php }else{ ?>
...
?>
			...
			<p class="submit">
				<input type="submit" value="<?php echo smartyTranslate(array('s'=>'Remind my friend(s)','mod'=>'referralprogram'),$_smarty_tpl);?>
" name="revive" id="revive" class="button_large" />
			</p>
		</form>
		<?php }else{ ?>
			<p class="warning"><?php echo smartyTranslate(array('s'=>'You have not sponsored any friends.','mod'=>'referralprogram'),$_smarty_tpl);?>
</p>
		<?php }?>
	</div>
...
icon/my-account.gif" alt="" class="icon" /> <?php echo smartyTranslate(array('s'=>'Back to Your Account','mod'=>'referralprogram'),$_smarty_tpl);?>
</a></li>
	<li class="f_right"><a href="<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/home.gif" alt="" class="icon" /> <?php echo smartyTranslate(array('s'=>'Home','mod'=>'referralprogram'),$_smarty_tpl);?>
</a></li>
</ul>
<?php }} ?>